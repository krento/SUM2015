                    ...
                    CHAR *CmdLine, INT ShowCmd )
{
  ...
  LA1_AnimAddUnit(LA1_UnitModelCreate());
  LA1_AnimAddUnit(LA1_UnitControlCreate());
  LA1_AnimAddUnit(LA1_UnitCCreate());
                                 ...
                                 WPARAM wParam, LPARAM lParam )
{
  ...
  case WM_CREATE:
    ...
    if (!LA1_AnimInit(hWnd))
      return -1;
    return 0;
  case WM_SIZE:
    LA1_AnimResize(LOWORD(lParam), HIWORD(lParam));
    LA1_AnimRender();
    return 0;
  case WM_TIMER:
    LA1_AnimRender();
    ...
    return 0;
  case WM_MOUSEWHEEL:
    LA1_MouseWheel += (SHORT)HIWORD(wParam) / WHEEL_DELTA;
    return 0;
  case WM_ERASEBKGND:
    return 1;
  case WM_PAINT:
